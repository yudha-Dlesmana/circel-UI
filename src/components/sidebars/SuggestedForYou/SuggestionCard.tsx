        ...
        {data?.map((item) => (
          <li className="flex items-center gap-3">
            <Avatar className="size-10">
              ...
              <AvatarFallback className="text-lg font-bold text-[var(--primary-color)]">{item.name.charAt(0)}</AvatarFallback>
            </Avatar>
            <div className="flex flex-1 text-sm items-center justify-between">
              ...
              <button className="border px-3 py-1 rounded-full font-bold">
                Follow
                </button>
            </div>
